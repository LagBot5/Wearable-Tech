...
#         utime.sleep(0.05)  # brief pause between notes

def playtone(frequency):
    speaker.duty_u16(500) # turn the PWM duty to 50%
...
# melody = [
#     tones['G4'], tones['G4'], tones['G4'], tones['D4'],
#     tones['G4'], tones['G4'], tones['G4'], tones['D4'],
#     tones['G4'], tones['G4'], tones['G4'], tones['D4'],
#     tones['C4'], tones['C4'], tones['C4'], tones['D4']
# ]
